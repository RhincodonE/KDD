...
Section('data', 'data related stuff').params(
    train_dataset=Param(str, 'file to store in datasets', required=True),
    test_dataset=Param(str, 'file to store val datasets', required=True),
...
@param('data.gpu')
def make_dataloaders(train_dataset=None, test_dataset=None, batch_size=None, num_workers=None, gpu=0):
    paths = {
        'train': train_dataset,
        'test': test_dataset
    }
...
if __name__ == "__main__":
    ...
    ch.save(model_in.state_dict(), config['training.model_save_path'])
