...
def clustering(net, X_train,class_num,addr='./Data'):
    ...
    clt = KMeans(n_clusters=class_num)
    ...
    print("Clustering finished! Start storing..")
    ...
    with open(addr_store_original_train+'label.txt','a') as f1, open(addr_store_original_train+'class.txt','a') as f2:
        ...
        for labelID in labelIDs:
            ...
            for i in idxs:
                ...
                dirName_o = addr+'/con/original/train/imgs/'+str(img_name)+'.png'

                origin_img.save(dirName_o)

                f1.write(dirName_o+' '+str(labelID)+'\n')
...
if __name__ == '__main__':
    ...
    dataset_loaders = [Fashion(),Mnist(),Emnist(),Emotion(),Clothing()]
    ...
    clustering(net, X_train,class_num = 45)
