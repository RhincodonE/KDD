...
def main(root_dir):
    ...
    fig = go.Figure(go.Treemap(
        ...
        labels=labels,
        parents=parents,
  # This sets the line color to black for contrast
        textfont=dict(color='black')
    ))

    fig.update_layout(
        margin=dict(t=0, l=0, r=0, b=0),
        paper_bgcolor='white',  # Set the background color for the entire figure to white
        plot_bgcolor='white',  # Set the background color for the plot area to white
    )
